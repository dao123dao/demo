...
public class AntZipUtil {
     ...
     * @param fileNames      根目录下待压缩的文件或文件夹名
     * @param targetFileName 目标ZIP 文件 星号 "*" 表示压缩根目录下的全部文件
     */
...
// System.out.println("测试文件1：" +fileName);
    ...
    public static void main(String[] temp) {
        // 压缩
        String baseDirName = "D:\\test\\";
        String[] fileNames = {"1.txt", "2.txt"};
        String zipFileName = "D:\\test2\\中文.zip";
        // 压缩多个指定的文件 到ZIP
        System.out.println(AntZipUtil.zip(baseDirName, fileNames, zipFileName, "UTF-8"));
